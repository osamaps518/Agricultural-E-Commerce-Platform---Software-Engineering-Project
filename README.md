...
* Developed core features including product catalog management, shopping cart functionality, order processing, and real-time delivery tracking
* Created detailed technical specifications including 35+ user requirements and corresponding system requirements
* Applied software engineering best practices: requirements analysis, system modeling, architectural design with 3-tier architecture
* Conducted effort estimation and project planning, calculating development costs and timelines for stakeholder approval
* Designed database schema and data persistence layer for handling transactions, inventory, and customer data
